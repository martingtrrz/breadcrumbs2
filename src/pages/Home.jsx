...
const FEATURES = [
  { icon: '✦', label: 'Diseño de interiores', sub: 'Ambientación personalizada' },
  { icon: '♪', label: 'Equipo audiovisual', sub: 'Sonido e iluminación 4K' },
  { icon: '◈', label: 'Jardín y terraza', sub: 'Espacios al aire libre' },
  { icon: '⚑', label: 'Catering gourmet', sub: 'Cocina internacional' },
]
